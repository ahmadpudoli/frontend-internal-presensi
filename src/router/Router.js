...
const Router = () => {
    ...
    const FinalRoute = (props) => {
        ...
        if ((!isUserLoggedIn() && route.meta === undefined) || (!isUserLoggedIn() && route.meta && !route.meta.authRoute && !route.meta.publicRoute)) {
            ...
            return <Redirect to="/logininternal" />;
        } else if (route.meta && route.meta.authRoute && isUserLoggedIn()) {
            // console.log(1);
            // console.log(route.meta);
            // console.log(route.meta.authRoute);
            ...
            if (user) {
                // Jika ada session, maka baca expired session nya
                // Redirect ke login dan hapus session, jika waktu saat ini sudah melewati expired 
        ...
        <AppRouter>
            <Switch>
                ...
                <Route
                    ...
                    path="/"
                    render={() => {
                        return isUserLoggedIn() ? <Redirect to={DefaultRoute} /> : <Redirect to="/logininternal" />;
                    }}
                />
                {/* Not Auth Route */}
                <Route
